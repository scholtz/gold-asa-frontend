import {
  AsaGoldSmartcontractCallFactory,
  AsaGoldSmartcontractClient
} from '../../contracts/clients/AsaGoldSmartcontractClient'
...
const clientNotForSaleTxs = async (input: IClientChangePriceInput) => {
  ...
  var compose = input.appClient.compose().setNotForSale(
    {
...
export default clientNotForSaleTxs
