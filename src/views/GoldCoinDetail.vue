...
<template>
  <Layout :hideTopMenu="false">
    <div class="grid coin-detail" v-if="product">
      <div class="col-12 md:col-4 py-8">
        <Galleria
          ref="galleria"
          ...
          <template #footer>
            <div class="flex align-items-center bg-black-alpha-90 text-300">
              ...
              <Button
                ...
                :pt="{
                  root: {
                    class: 'border-none border-noround ml-auto hover:bg-white-alpha-10 text-300',
                    style: 'background: transparent'
                  }
                }"
              />
      ...
      <div class="md:col-4">
        <h1>{{ product.nft.properties.name }}</h1>
        <SaleCoin
          :item="product"
        ...
        />
        <table id="values-table" v-else>
          <tr>
            <th></th>
            <td>
              <BuyButton :assetId="product.state.asset1" :item="product"></BuyButton>
            </td>
          </tr>
          ...
          <tr v-if="product.nft.properties.diameter">
            <th>Diameter</th>
            <td>{{ product.nft.properties.diameter }} {{ product.nft.properties.diameterUnit }}</td>
          </tr>
          ...
          <tr v-if="product.nft.properties.goldWeight">
            ...
            <td>{{ product.nft.properties.goldWeight }} {{ product.nft.properties.weightUnit }}</td>
          </tr>
      ...
      <div class="md:col-4" v-if="product.nft.properties.story">
        <h4>Story</h4>
        <p class="story">{{ product.nft.properties.story }}</p>
      </div>
    </div>
    <div v-else>
